...
raw_data <-raw_data %>%
  mutate(product_smartphone = ifelse(`Product category` == "Smartphone", 1, 0),
         product_tv = ifelse(`Product category` == "TV", 1, 0),
         product_laptop = ifelse(`Product category` == "Laptop", 1, 0),
         product_tablet = ifelse(`Product category` == "Tablet", 1, 0))
View(raw_data)
